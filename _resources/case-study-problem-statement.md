...
Estimated time: 6–8 hours over up to one week.
Context
...
Submission
Send us a repo plus a ~5 minute walkthrough video (Loom or similar) showing one startup end-to-end.
...
Weight
What we look for
Process & AI workflow visibility
40%
By the end of reviewing your submission, do we have a real picture of how you thought, planned, and worked with AI? The form is yours to choose; the choice of form is part of what's graded.
Output quality
20%
Memos a partner would actually skim. Scores defensible. Robust to bad or missing data.
Scoping & judgment
20%
Right problems picked. Right corners cut. Thesis is specific and held consistently.
System design
10%
Clean separation between stages. Replayable. No overengineering.
Code quality
10%
Readable, modular, appropriately tested.
Ground Rules
...
A partner can:
Run one command, point it at a topic, get memos out the other end.
Open any memo and understand the call in 60 seconds.
A reviewer can:
Spot-check one analysis and trust where its claims came from.
Walk away with a real picture of how you worked.
Ship that and stop.